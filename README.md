...
(3) Casa6_Tools : An example using the synthesisXXXX tools. The current version is identical to (2) in functionality, but will be edited to include iteration control options such as editing niter. cycleniter, etc.
