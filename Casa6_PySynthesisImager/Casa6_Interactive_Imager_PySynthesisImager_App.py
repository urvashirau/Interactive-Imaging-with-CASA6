...
from Casa6_Interactive_Imager_PySynthesisImager import ImageCleaner
...
app.layout = html.Div(children=[
    ...
    html.Div(children=[
        ...
        dcc.RadioItems( id='add_or_erase', 
                        options=[
                            {'label':'Add mask', 'value':'add'},
                            {'label':'Erase mask', 'value':'erase'} ],
                        value='add', labelStyle={'display': 'inline-block'}),          
...
@app.callback(
    ...
    [   Input('cont_button', 'n_clicks'),
     ...
     state=[ State('add_or_erase','value')]
)
def update_figure(cont_clicks, stop_clicks, selected_data, add_erase):
    ...
    return [
            ...
            )} ,
        {
            ...
            'layout': go.Layout(
                ...
                yaxis={'title': 'Peak Residual, Model Flux'},
                title="Convergence Plot : Peak Residual and Model Flux vs Iteration Number",
